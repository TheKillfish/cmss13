...
/mob/living/carbon/xenomorph
	...
	// Queen maturity mechanics made universal, for Hive Modularization
	...
	// Queen ovi indicator made universal, for Hive Modularization
...
/mob/living/carbon/xenomorph/proc/recalculate_everything()
	...
	update_icon_source()
	if(hive && hive.living_hiveleader && hive.living_hiveleader == src)
