...
/datum/hive_status/proc/get_xeno_counts()
	...
	var/list/xeno_counts = list(
		...
		list(XENO_CASTE_BOILER = 0, XENO_CASTE_CRUSHER = 0, XENO_CASTE_PRAETORIAN = 0, XENO_CASTE_RAVAGER = 0, XENO_CASTE_DECIEVER = 0,)
	)
...
/datum/hive_status/proc/get_xeno_icons()
	...
	var/list/xeno_icons = list(
		...
		list(XENO_CASTE_BOILER = "", XENO_CASTE_CRUSHER = "", XENO_CASTE_PRAETORIAN = "", XENO_CASTE_RAVAGER = "", XENO_CASTE_DECIEVER = "")
	)
