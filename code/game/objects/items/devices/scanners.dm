...
/datum/looping_sound/healthanalyzer_oxygen_beeping
	start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_oxygen_alarm.ogg' = 1)
	mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_oxygen_alarm.ogg' = 1)
	mid_length = 1 SECONDS
	volume = 3
	extra_range = 14

/datum/looping_sound/healthanalyzer_heart_beeping
	start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_flatline.ogg' = 1)
	mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_flatline.ogg' = 1)
...
/obj/item/device/healthanalyzer/soul
	...
	item_state = "pve_health_analyzer"
	item_icons = list(
		WEAR_WAIST = 'icons/mob/humans/onmob/clothing/belts/tools.dmi',
		WEAR_BACK = 'icons/mob/humans/onmob/clothing/belts/tools.dmi',
		WEAR_J_STORE = 'icons/mob/humans/onmob/clothing/belts/tools.dmi',
		WEAR_L_HAND = 'icons/mob/humans/onmob/inhands/equipment/devices_lefthand.dmi',
		WEAR_R_HAND = 'icons/mob/humans/onmob/inhands/equipment/devices_righthand.dmi',
		)
	item_state_slots = list(
		WEAR_WAIST = "pve_health_analyzer",
		WEAR_BACK = "pve_health_analyzer",
		WEAR_J_STORE = "pve_health_analyzer",
		WEAR_L_HAND = "pve_health_analyzer",
		WEAR_R_HAND = "pve_health_analyzer",
		)
...
/obj/item/device/healthanalyzer/soul/process()
	...
	if(health_percentage >= 40)
		heart_rate_loop.start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_okay.ogg' = 1)
		heart_rate_loop.mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_okay.ogg' = 1)
		heart_rate_loop.mid_length = 0.703 SECONDS
	if(health_percentage < 40)
		heart_rate_loop.start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_bad.ogg' = 1)
		heart_rate_loop.mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_bad.ogg' = 1)
		heart_rate_loop.mid_length = 0.499 SECONDS
	if(health_percentage < -20)
		heart_rate_loop.start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_very_bad.ogg' = 1)
		heart_rate_loop.mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_very_bad.ogg' = 1)
		heart_rate_loop.mid_length = 0.550 SECONDS
	if(health_percentage < -100)
		heart_rate_loop.start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_severe.ogg' = 1)
		heart_rate_loop.mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_severe.ogg' = 1)
		heart_rate_loop.mid_length = 0.374 SECONDS
	if(connected_to.stat > 1) //they're dead
		heart_rate_loop.start_sound = list('sound/items/pve_health_analyzer/healthanalyzer_heart_flatline.ogg' = 1)
		heart_rate_loop.mid_sounds = list('sound/items/pve_health_analyzer/healthanalyzer_heart_flatline.ogg' = 1)
...
/obj/item/device/healthanalyzer/soul/attack(mob/living/M, mob/living/user)
	...
	if(istype(M, /mob/living/carbon/human))
		...
		icon_state = "pve_health_analyzer_open"
