...
#define XENO_SHIELD_SOURCE_CENTURION 12
...
#define XENO_CASTE_CENTURION	"Centurion"
#define XENO_T2_CASTES    list(XENO_CASTE_BURROWER, XENO_CASTE_CARRIER, XENO_CASTE_HIVELORD, XENO_CASTE_LURKER, XENO_CASTE_WARRIOR, XENO_CASTE_SPITTER, XENO_CASTE_CENTURION)
//t3
